...
$t_show_tags = in_array('tags', $t_fields) &&
        access_has_project_level(
                config_get('tag_attach_threshold', /* default */ null, /* user */ null, $t_project_id), $t_project_id);
                        ...
                        <table class="table table-bordered table-condensed">
                            ...
                            if ($t_show_due_date) {
                                ...
                                <tr style="display:none;">
                                    ...
                                    <td>
                                        <?php
                                        echo '<input ' . helper_get_tab_index() . ' type="text" id="due_date" name="due_date" class="datetimepicker input-sm" ' .
                                    ...
                                    <td>
                                        <select <?php echo helper_get_tab_index() ?> name="status" class="input-sm">
                                            ...
                                            $t_resolution_options = get_status_option_list(
                                                    access_get_project_level($t_project_id), config_get('bug_submit_status'), true, ON == config_get('allow_reporter_close'), $t_project_id);
                            ...
                            <tr>
                                ...
                                <td>
                                    <input <?php echo helper_get_tab_index() ?> type="text" id="summary" name="summary" size="105" maxlength="128" value="<?php echo string_attribute($f_summary) ?>" placeholder="Subject" required />
                                </td>
                            </tr>
                            <tr>
                                <th class="category">
                            ...
                            <tr>
                                <th class="category">
                                    <span class="required">*</span><label for="os">Your Name</label>
                                </th>
                                <td><?php
                                    echo '<input type="text" id="os" name="os" class="typeahead input-sm" size="32" maxlength="32" tabindex="' . helper_get_tab_index_value() . '" value="' . string_attribute($f_os) . '" placeholder="Your Name" required/>';
                                    ?>
                                </td>
                            </tr>
                            <?php if ($t_show_tags) { ?>
                            ...
                            if ($t_show_view_state) {
                                ...
                                <tr style="display:none;">
                                    ...
                                    <td>
                                        <label>
                                            <input <?php echo helper_get_tab_index() ?> type="radio" class="ace" name="view_state" value="<?php echo VS_PUBLIC ?>" />
                                            <span class="lbl padding-6"><?php echo lang_get('public') ?></span>
                                        </label>
                                        &#160;&#160;&#160;&#160;
                                        <label>
                                            <input <?php echo helper_get_tab_index() ?> type="radio" class="ace" name="view_state" value="<?php echo VS_PRIVATE ?>" checked="checked" />
