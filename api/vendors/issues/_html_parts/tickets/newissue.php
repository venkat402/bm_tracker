...
<div id="newissue">
    <div class="alert alert-info">
        <strong><?= $ticket_edit === true ? $this->lang_php['update_ticket'] : $this->lang_php['new_issue'] ?></strong> Please fill the bellow to create issue / ticket 
    </div>
    <?= $this->get_alert() ?>
    <form class="form-horizontal newissue" role="form" method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="assignee">Bug Raised By * </label>
            <div class="col-sm-10">
                <input type="text" required class="form-control" name="assignee"  maxlength="200" value="<?= isset($_POST['assignee']) ? $_POST['assignee'] : '' ?>" id="subject" placeholder="Your Name">
            </div>
        </div>
